...
export async function up({ db, payload, req }: MigrateUpArgs): Promise<void> {
  await db.execute(sql`
   CREATE TYPE "public"."enum_pages_blocks_hero_style" AS ENUM('gradient', 'image', 'minimal', 'dark');
  CREATE TYPE "public"."enum_pages_blocks_cta_style" AS ENUM('gradient', 'outline', 'dark');
  CREATE TYPE "public"."enum_pages_status" AS ENUM('draft', 'published');
  CREATE TYPE "public"."enum_posts_status" AS ENUM('draft', 'published');
  CREATE TYPE "public"."enum_footer_social_links_platform" AS ENUM('instagram', 'facebook', 'linkedin', 'tiktok', 'youtube');
  CREATE TABLE "pages_blocks_hero" (
  	...
  	"style" "enum_pages_blocks_hero_style" DEFAULT 'gradient',
  	"block_name" varchar
  );
  ...
  CREATE TABLE "pages_blocks_cta" (
  	...
  	"heading" varchar NOT NULL,
  	"description" varchar,
  	"button_label" varchar DEFAULT 'Jetzt starten' NOT NULL,
  	"button_link" varchar DEFAULT '/kontakt' NOT NULL,
  ...
  CREATE TABLE "pages_blocks_pricing_plans" (
  	...
  	"period" varchar DEFAULT '/Monat',
  	"highlighted" boolean DEFAULT false,
  	"cta_label" varchar DEFAULT 'Auswählen',
  	"cta_link" varchar DEFAULT '/kontakt'
  );
  ...
  CREATE TABLE "services" (
  	...
  	"icon" varchar,
  	"pricing" varchar,
  	"cta_label" varchar DEFAULT 'Mehr erfahren',
  	"cta_link" varchar,
  	"image_id" integer,
  	"order" numeric,
  	"updated_at" timestamp(3) with time zone DEFAULT now() NOT NULL,
  ...
  CREATE TABLE "footer" (
  	"id" serial PRIMARY KEY NOT NULL,
  	"copyright" varchar DEFAULT '© 2026 Epic Arts',
  	"updated_at" timestamp(3) with time zone,
  	"created_at" timestamp(3) with time zone
  );
  ...
  CREATE TABLE "site_settings" (
  	"id" serial PRIMARY KEY NOT NULL,
  	"site_name" varchar DEFAULT 'Epic Arts' NOT NULL,
  	"tagline" varchar,
  	"logo_id" integer,
  	"favicon_id" integer,
  	"colors_primary" varchar DEFAULT '#fc40af',
  	"colors_secondary" varchar DEFAULT '#a6bef4',
  	"colors_accent" varchar DEFAULT '#ff2d2a',
  	"contact_email" varchar,
  	"contact_phone" varchar,
  	"contact_address" varchar,
  	"analytics_ga_id" varchar,
  	"analytics_fb_pixel_id" varchar,
